...
*   “*If I won the lottery, I would travel around the world.*”, There is a very low probability (1%) that the first part of this sentence will happen. But if it happens, the second part is 100% certain.
...
<span class="formula">If + past simple, would/wouldn’t + verb.</span>
...
<span class="formula">Would + verb if + past simple.</span>
...
| Conditional | Meaning | Structure |
| :--- | :--- | :--- |
| **0** | Si haces *a* pasa *b* | <span class="formula">If + Present Simple + Result (Present Simple)</span> |
| **1** | Si haces *a* va a pasar *b* | <span class="formula">If + Present Simple + Will + Verb (Infinitive)</span> |
| **2** | Si pasase *a* pasaría *b* | <span class="formula">If + Past Simple + Would + Verb (Infinitive)</span> |
 If + Condición <em>(oración con verbo conjugado en past simple)</em>